...
public class IUTextual {
	...
	public void listarReserva() {
		...
		if (reserva != null) {
			System.out.println("Lista de las reservas: ");
			//modelo.realizarReserva(reserva);
		}
	}
	...
	public void consultarDisponibilidad() {
		...
		if (isDisponible)
			System.out.println("aula " +aula.getNombre() + " esta disponible para la " + tramo.toString() + " al día " + dia.toString());
		else
			System.out.println("aula " +aula.getNombre() + " no esta disponible para la " + tramo.toString() + " al día " + dia.toString());
	}
